...
def lambda_handler(event, context):
    ...
    mc = ("two brothers", "two sisters", "a divorced couple", "a man and his alien neighbor", "a CEO and his assistant", "a waitress and doctor", "a grandmother and her caretaker", "three cousins", "a couple", "a cheerleader and a amster chess player", "a mother and son", "a mob boss and cop", "four friends", "a teacher and the principal", "a doctor and a hidden royal", "a librarian and a single father of two", "a bar owner and their alcohol delievery person", "a mailman and a single mother")
    action = ("run a cartel", "run a small family business", "encounter aliens", "help a lost angel", "search for the fountain of youth", "teach a group of hidden vampires", "explore time and space", "go to the olympics", "meet a ghost", "write a book", "befriend a bear", "befriend a pack of werewolves", "cause a war between two gangs", "fly around the world in search of treasure", "plan a trip to pluto", "fail at being buddy cops", "spy on a group of grandmothers", "break into a bank on accident", "invent a new color", "discover a new category of lizard", "invite Godzilla over for tea", "pretend to be wizards", "switch places with each other")
    ...
    HairColor = ("red", "pink", "purple", "blonde", "blue", "brunette", "green", "gray", "white", "black", "rainbow colored", "blonde with pink stripes", "blonde with pink highlights", "black with blue stripes", "brown with highlights")
    Hairdesc = ("short", "shoulder length", "curly", "wavy", "long", "straight",  "pixie cut") 
    Likes = ("Basketball", "dogs", "cats", "the color pink", "the color teal", "inventing", "science", "art", "money", "food", "sleep", "dancing", "research", "jumping out of planes", "pranking people", " their best friend", "brother", "family", "cooking", "baking", "drawing", "gossiping", "shopping", "acting", "pizza", "ice cream", "high-fives", "roller coasters", "buddy cop movies")
