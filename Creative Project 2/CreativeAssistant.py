...
def lambda_handler(event, context):
    ...
    action = ("run a cartel", "run a small family business", "encounter aliens", "help a lost angel", "search for the fountain of youth", "teach a group of hidden vampires", "explore time and space", "go to the olympics", "meet a ghost", "write a book", "befriend a bear", "befriend a pack of werewolves", "cause a war between two gangs", "fly around the world in search of treasure", "plan a trip to pluto", "fail at being buddy cops", "spy on a group of grandmothers", "break into a bank on accident", "invent a new color", "discover a new category of lizard", "invite Godzilla over for tea", "pretend ot be wizards", "switch places with each other")
