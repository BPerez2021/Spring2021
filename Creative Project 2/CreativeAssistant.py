...
if event["currentIntent"]["name"] == "Prompt":
    result["dialogAction"]["message"]["content"] = ("A  " + random.choice(Genre) + " story about " + random.choice(mc) + " who " + random.choice(action) + " and " + random.choice(action) + ".")
...
if event["currentIntent"]["name"] == "Ending":
    result["dialogAction"]["message"]["content"] = ("In the end, the main character " + random.choice(end))
     ...
     #Sidekick
relationship = ("best friend", "brother", "sister", "grandmother", "dog", "cat", "parrot", "neighbor", "cousin", "friend", "co-worker", "boss" )
